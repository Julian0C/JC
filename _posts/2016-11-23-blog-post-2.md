...
<p float="left">
  <img src="/JC/images/svm_multiple_hyperplanes.png" width="250" />
  <img src="/JC/images/svm_maximum_margin.png" width="250" /> 
</p>
...
<p float="left"><img src="/JC/images/svm_formula3.png" width="300" /></p>                     
...
<p float="left"><img src="/JC/images/svm_formula4.png" width="160" /> </p>    
...
<p float="left"><img src="/JC/images/svm_formula5.png" width="400" /></p>  

Then, set the derivatives of L(w, b, a) with respect to w, b to 0, we get 2 conditions:
<p float="left"><img src="/JC/images/svm_formula6.png" width="170" /></p>  
Put these 2 conditions back into previous formula: 
<p float="left"><img src="/JC/images/svm_formula7.png" width="400" /></p>  
s.t.
<p float="left"><img src="/JC/images/svm_formula8.png" width="250" /></p>  
**Soft Margin:**
...
<p float="left"><img src="/JC/images/svm_formula9.png" width="150" /></p> 
where C > 0, it controls the trade-off between the slack variable and the margin. Then, the Lagrangian formula is defined as:
<p float="left"><img src="/JC/images/svm_formula10.png" width="450" /></p> 
With KKT conditions:
<p float="left"><img src="/JC/images/svm_formula11.png" width="180" /></p> 
...
<p float="left"><img src="/JC/images/svm_formula12.png" width="220" /></p> 
<p float="left"><img src="/JC/images/svm_formula13.png" width="380" /></p> 
s.t. 
<p float="left"><img src="/JC/images/svm_formula14.png" width="100" /></p> 
Then, we can obtain b by averaging:
<p float="left"><img src="/JC/images/svm_formula15.png" width="330" /></p> 
